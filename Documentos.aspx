    ...
    <asp:Repeater ID="rptDocumentos" runat="server">
        <HeaderTemplate>
            <table class="table table-striped table-hover table-sm align-middle mb-0 documents-table">
                <colgroup>
                    ...
                    <col class="col-name" /><col class="col-classification" /><col class="col-human-result" />
                    <col class="col-method" /><col class="col-confidence" /><col class="col-reason" />
                    <col class="col-origin" /><col class="col-actions" />
                </colgroup>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td class="doc-classification"><span class="badge rounded-pill text-bg-secondary"><%#: Eval("ClasificacionMostrada") %></span></td>
                <td class="doc-human-result"><%#: Eval("ResultadoHumanoMostrado") %></td>
                ...
                <td class="text-nowrap"><asp:PlaceHolder runat="server" Visible='<%# (bool)Eval("PuedeVer") %>'><asp:PlaceHolder runat="server" Visible='<%# (bool)Eval("PendienteRevision") %>'><a class="btn btn-sm btn-primary me-1" href='<%#: "Documento_Revisar.aspx?id="+Eval("Id") %>'>Revisar</a></asp:PlaceHolder><a class="btn btn-sm btn-outline-secondary" target="_blank" href='<%#: "Documento_Ver.aspx?id="+Eval("Id") %>'>Ver</a></asp:PlaceHolder><asp:PlaceHolder runat="server" Visible='<%# !(bool)Eval("PuedeVer") %>'><span class="text-secondary">—</span></asp:PlaceHolder></td>
            </tr>
        </ItemTemplate>
